...
def plot_wr_ratio_cdf():
    plt.figure(figsize=(7, 4))
    with open('../data/plot_files/public_wr_ratio.json', 'r') as f:
        public_map = json.load(f)
    with open('../data/plot_files/user_wr_ratio.json', 'r') as f:
    ...
    plt.xlabel('Read ratio', fontsize=FONT_SIZE+1)
    plt.legend()
    plt.tight_layout()
    save_path = '../fig/fig8.pdf'
